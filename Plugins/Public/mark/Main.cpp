...
EXPORT void LoadSettings()
{
    ...
    scMarkFile = string(szCurDir) + "\\flhook_plugins\\mark.cfg";
...
void UserCmd_MarkObj(uint iClientID, const wstring &wscParam)
{
	...
	case 0: 
		...
		break;
	case 1:
		PrintUserCmdText(iClientID, L"You must have something targeted to mark it.");
		break;
	case 2:
		PrintUserCmdText(iClientID, L"You cannot mark cloaked ships.");
		break;
	case 3:
		PrintUserCmdText(iClientID, L"Object is already marked.");
	default:
		break;
	}
}
...
void UserCmd_UnMarkObj(uint iClientID, const wstring &wscParam)
{
	...
	case 0: 
		...
		break;
	case 1:
		PrintUserCmdText(iClientID, L"You must have something targeted to unmark it.");
		break;
	case 2:
		PrintUserCmdText(iClientID, L"Object is not marked.");
	default:
		break;
	}
}
